...
export const Popup = props => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, open && root && /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React.createElement("div", {
    ...
    autoFocus: true,
    ref: modalRef
  }, UIComponent && /*#__PURE__*/React.createElement(UIComponent, props)), root));
};
Popup.propTypes = {
   ...
   * Content of popup
   */
  content: PropTypes.oneOfType([PropTypes.string, PropTypes.arrayOf(string), PropTypes.elementType, PropTypes.element]),
  /**
