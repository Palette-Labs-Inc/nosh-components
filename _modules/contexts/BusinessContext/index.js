 ...
 */
export const BusinessContext = /*#__PURE__*/createContext();
...
export const BusinessProvider = ({
  ...
  const getBusiness = async id => {
    try {
      ...
      } = await ordering.businesses(id).select(businessParams).get();
      setState({
        ...state,
        loading: false,
  ...
  return /*#__PURE__*/React.createElement(BusinessContext.Provider, {
