 ...
 */
export const OptimizationLoadContext = /*#__PURE__*/createContext();

/**
 * Api provider to manage api request
 * @param {props} props
 */
export const OptimizationLoadProvider = ({
  settings,
  children,
  strategy
}) => {
  ...
  return /*#__PURE__*/React.createElement(OptimizationLoadContext.Provider, {
