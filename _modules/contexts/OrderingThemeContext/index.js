 ...
 */
export const OrderingThemeContext = /*#__PURE__*/createContext();
 ...
 * @param {props} props
 */
export const OrderingThemeProvider = ({
  children,
  settings
}) => {
  ...
  useEffect(() => {
    ...
    const _themes = optimizationLoad.result && !!optimizationLoad.result?.theme ? {
      ...
      result: {
        values: optimizationLoad.result?.theme
      }
    } : null;
    getThemes(_themes);
  }, [optimizationLoad]);
  ...
  return /*#__PURE__*/React.createElement(OrderingThemeContext.Provider, {
